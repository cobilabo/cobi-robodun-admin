...
const CUE_DEFAULTS: Record<string, CuePrompt> = {
  ...
  bgm_boss: {
    ...
    ja: [
      STYLE_JA,
      '用途: ボス戦 BGM（loop）',
      'ムード: 通常戦闘より強めの緊張と威圧。それでもロボダンらしいコミカルSF感は残す',
      'テンポ: だいたい 124–136 BPM',
      '構成: 通常戦より厚めの低音とドラマチックなモチーフ。ループ前提、長いブレイクなし',
      '楽器: 低めのシンセベース、鋭いリード、広めのパッド、金属的なパーカッション',
      '必須: インストのみ。過度な不協和やホラーストリングは避ける',
    ].join('\n'),
    en: [
      ROBODUN_AUDIO_STYLE,
      'Cue: boss battle BGM (looping).',
      'Mood: more pressure and weight than normal battle, still whimsical sci-fi — not grimdark horror.',
      'Tempo: about 124–136 BPM.',
      'Form: thicker low end and a dramatic motif; loop-first; avoid long quiet breaks.',
      'Instruments: deeper synth bass, sharper lead, wider pads, metallic percussion accents.',
      'Must: fully instrumental; avoid extreme dissonance and horror strings.',
    ].join(' '),
  },
